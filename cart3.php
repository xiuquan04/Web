<?php
    session_start();
    $database_name = "Productthree_details";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="cart3.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
							...
							<td><input type="submit" a href="men.html" name="add" style="margin-top: 5px;" class="btn btn-success"
                                       value="Pay"></td>
                            <td></td>
                        </tr>
                        <?php
